...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" name="rp16" size="3" maxlength="3"></td>
			<td width="22" align="right">17:</td>
			<td><input type="text" name="rp17" size="3" maxlength="3"></td>
			<td width="22" align="right">18:</td>
			<td><input type="text" name="rp18" size="3" maxlength="3"></td>
			<td width="22" align="right">19:</td>
			<td><input type="text" name="rp19" size="3" maxlength="3"></td>
			<td width="22" align="right">20:</td>
			<td><input type="text" name="rp20" size="3" maxlength="3"></td>
		</tr>
		<tr>
			<td width="22" align="right">21:</td>
			<td><input type="text" name="rp21" size="3" maxlength="3"></td>
			<td width="22" align="right">22:</td>
			<td><input type="text" name="rp22" size="3" maxlength="3"></td>
			<td width="22" align="right">23:</td>
			<td><input type="text" name="rp23" size="3" maxlength="3"></td>
			<td width="22" align="right">24:</td>
			<td><input type="text" name="rp24" size="3" maxlength="3"></td>
			<td width="22" align="right">25:</td>
			<td><input type="text" name="rp25" size="3" maxlength="3"></td>
		</tr>
		<tr>
			<td width="22" align="right">26:</td>
			<td><input type="text" name="rp26" size="3" maxlength="3"></td>
			<td width="22" align="right">27:</td>
			<td><input type="text" name="rp27" size="3" maxlength="3"></td>
			<td width="22" align="right">28:</td>
			<td><input type="text" name="rp28" size="3" maxlength="3"></td>
			<td width="22" align="right">29:</td>
			<td><input type="text" name="rp29" size="3" maxlength="3"></td>
			<td width="22" align="right">30:</td>
			<td><input type="text" name="rp30" size="3" maxlength="3"></td>
		</tr>
		<tr>
			<td width="22" align="right">31:</td>
			<td><input type="text" name="rp31" size="3" maxlength="3"></td>
			<td width="22" align="right">32:</td>
			<td><input type="text" name="rp32" size="3" maxlength="3"></td>
			<td width="22" align="right">33:</td>
			<td><input type="text" name="rp33" size="3" maxlength="3"></td>
			<td width="22" align="right">34:</td>
			<td><input type="text" name="rp34" size="3" maxlength="3"></td>
			<td width="22" align="right">35:</td>
			<td><input type="text" name="rp35" size="3" maxlength="3"></td>
		</tr>
		<tr>
			<td width="22" align="right">36:</td>
			<td><input type="text" name="rp36" size="3" maxlength="3"></td>
			<td width="22" align="right">37:</td>
			<td><input type="text" name="rp37" size="3" maxlength="3"></td>
			<td width="22" align="right">38:</td>
			<td><input type="text" name="rp38" size="3" maxlength="3"></td>
			<td width="22" align="right">39:</td>
			<td><input type="text" name="rp39" size="3" maxlength="3"></td>
			<td width="22" align="right">40:</td>
			<td><input type="text" name="rp40" size="3" maxlength="3"></td>
		</tr>
		</table>
	</td>
</tr>
