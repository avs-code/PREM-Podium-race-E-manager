...
<div>
<?php if(isset($standing_pages) && !empty($standing_pages)):?>
    <div class="w3-responsive">
        <ul class="w3-pagination">
            <?php
            foreach ($standing_pages as $spID => $spDetails) {
                ?>
                <li><a href="javascript:void(0)" class="tablink" onclick="openLink(event, 'standing_<?= $spID; ?>');"
                       title="<?= $spDetails['seasonName']; ?>/<?= $spDetails['seasonDivision']; ?>"><i
                                class="w3-margin-center"></i><?= $spDetails['page']; ?></a></li>
                <?php
            }
            ?>
        </ul>
        ...
        foreach ($standing_pages as $spID => $spDetails) {
            ...
            <div id="standing_<?= $spID; ?>" class="myLink">
                ...
                <!--Team standing-->
                <div class="w3-center w3-black w3-text-white"><h2><?= $spDetails['seasonName']; ?>
                        <br/><?= $spDetails['seasonDivision']; ?></div>
                </h2>
                <div class="w3-center w3-indigo w3-text-white"><h3>Team Standings</h3></div>
                <?php
