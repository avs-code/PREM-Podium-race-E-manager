...
-- Tiempo de generación: 03-10-2016 a las 07:31:52
...
CREATE TABLE IF NOT EXISTS `race` (
  ...
  `imagelink` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `sim_results` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `race_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `season` int(11) NOT NULL DEFAULT '0',
